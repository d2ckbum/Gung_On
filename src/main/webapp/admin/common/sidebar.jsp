        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link" href="/admin/adminMain.jsp">대시보드</a>
                    ...
                    <div class="collapse" id="collapseGung">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="/admin/admin_gung/gung_list.jsp">궁 목록</a>
                            <a class="nav-link" href="/admin/admin_gung/story_list.jsp">궁 이야기</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseEvent">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="/program/adminProgInfo/adminProgInfo.jsp">행사 목록</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseTicket">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="/Gung_On/ticket/ticketAdmin/manageFrm.jsp">예매 목록</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseView">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="/admin/admin_course/course_main.jsp">사용자 추천코스 관리</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseMember">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="/member/memberList.jsp">회원 목록</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseCS">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="/admin/admin_cs/cs_notice_main.jsp">공지사항</a>
                            <a class="nav-link" href="/admin/admin_cs/cs_faq_main.jsp">FAQ</a>
                            <a class="nav-link" href="/admin/admin_cs/cs_inquiry_main.jsp">1:1 문의</a>
                        </nav>
                    </div>
                </div>
            </div>

...
$(function(){
	history.pushState({ page: 'manageFrm' }, '', '/ticket/ticketAdmin/manageFrm.jsp');
	...
	$(".wrapTableBody").click(function(){
		...
		//debugger;
		//window.location.href="/ticket/ticketAdmin/manage_detail_Frm.jsp?bookingNum="+id;
		$.ajax({
...
<div class="title">
 <img src="/common/images/mainpage/header_icon.png" style="/* width: 120px; height: 100px; */  margin-right: 10px; ">  

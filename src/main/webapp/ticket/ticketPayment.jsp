...
<script src="/Gung_On/ticket/js/payment.js" type="text/javascript"></script>
...
<body>
	...
	<form id="calcFrm" action="/Gung_On/ticket/ticketProcess/ticket_calc_procss.jsp" method="post">
	    <div class="btnGroup">

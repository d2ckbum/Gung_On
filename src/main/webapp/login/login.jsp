            ...
            success: function(jsonObj) {
                if (jsonObj.loginResult) {
                    ...
                    if (redirectUrl) {
                        ...
                        window.location.href = "/mainpage/mainpage.jsp"; // 기본 페이지
                    }
                    /*          */
                    /* location.href = "/mainpage/mainpage.jsp"; // 로그인 성공 시 이동할 페이지 */
                } else {
...
<div class="login-container">
    ...
    <div class="link-container">
        <div class="link-box">
            <a href="/mypage/searchAccount.jsp" style="margin-right: 20px;">아이디/비밀번호 찾기</a>
            <span class="divider"></span>
            <a href="/signup/sign_up.jsp" style="margin-left: 10px;">회원가입</a>
        </div>
    </div>
</div>

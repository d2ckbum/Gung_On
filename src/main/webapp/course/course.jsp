...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/course/css/course_style.css" />
...
<script type="text/javascript">
  ...
  function loadContent(selectedValue) {
      ...
      const targetJspPath = '/course/' +'course_'+ selectedValue + '.jsp';
      ...
      fetch(targetJspPath)
          ...
          .then(html => {
              ...
              const popupContentJspPath = '/course/popup_' + selectedValue + '.jsp';

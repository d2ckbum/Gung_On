...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <nav class="sub-nav">
                <ul>
                    <li><a href="/course/course_rule.jsp" >관람규칙</a></li>
                    <li><a href="/course/course_time.jsp">관람시간</a></li>
                    <li><a href="/course/course.jsp" class="active">관람코스</a></li>
                    <li><a href="/course/users_course.jsp">사용자 추천 코스</a></li>
                </ul>
            </nav>
        </div>
							...
							<span class="course_tit"><img src="course_img/ic_loca.jpg" alt=""> 코스안내</span>
								<ul class="list course_info_list">
									<li class="item" data-num="0">
											<a href="#;"><span class="inn">🚶시간 별  코스</span></a>
										</li>
									</ul>
							</div>
						<select class="sel_st">
...
<div class="tab_con map_info current">
    ...
    <div class="f-custom-controls top-right">
        <button id="zoomInButton" class="zoomIn" data-panzoom-action="zoomIn" title="확대">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"></path></svg>
        </button>
    ...
    <div class="course_map" style="overflow: hidden; user-select: none; touch-action: none; width: 900px;">
        <div class="zoomable" id="panzoom-container" style="cursor: move; user-select: none; touch-action: none; transform-origin: 50% 50%;">
            <img data-id="1" class="map_content" src="course_img/gbg_img/gbg_map_all.png" alt="전체 맵" draggable="false"> 
        </div>
    </div>
</div>
						</div>
					...
					<div id="photoDiv">
                        <div class="tab_con_wrap course_slide_wrap">
                            <div class="tab_con cm1 current" data-tab="cm1">
                                <h3 class="txt_section_tit vcPartTitle">근정전</h3>
                                <div class="hidden">근정전</div>
                            ...
                            <div class="tab_con cm2" data-tab="cm2">
                                <h3 class="txt_section_tit vcPartTitle">사정전</h3>
                                <div class="hidden">사정전</div>
                            ...
                            <div class="tab_con cm3" data-tab="cm3">
                                <h3 class="txt_section_tit vcPartTitle">수정전</h3>
                                   <div class="hidden">수정전</div>
                            ...
                            <div class="tab_con cm4" data-tab="cm4">
                                <h3 class="txt_section_tit vcPartTitle">경회루</h3>
                                <div class="hidden">경회루</div>
                            ...
                            <div class="tab_con cm5" data-tab="cm5">
                                <h3 class="txt_section_tit vcPartTitle">강녕전</h3>
                                <div class="hidden">강녕전</div>
                            ...
                            <div class="tab_con cm6" data-tab="cm6">
                                <h3 class="txt_section_tit vcPartTitle">교태전</h3>
                                 <div class="hidden">교태전</div>
                            ...
                            <div class="tab_con cm7" data-tab="cm7">
                                <h3 class="txt_section_tit vcPartTitle">동궁</h3>
                                <div class="hidden">동궁</div>
                             ...
                             <div class="tab_con cm8" data-tab="cm8">
                                <h3 class="txt_section_tit vcPartTitle">소주방</h3>
                                <div class="hidden">소주방</div>
                             ...
                             <div class="tab_con cm9" data-tab="cm9">
                                <h3 class="txt_section_tit vcPartTitle">자경전</h3>
                                <div class="hidden">자경전</div>
                             ...
                             <div class="tab_con cm10" data-tab="cm10">
                                <h3 class="txt_section_tit vcPartTitle">흥복전</h3>
                                <div class="hidden">흥복전</div>
                                ...
                                <div class="course_txt_wrap">
                                    <div class="txt">
                                        <p>흥복전(興福殿)은 고종 대 경복궁을 다시 지을 때 처음 지어졌다.&nbsp;이곳은 고종 연간에 독일, 일본, 이탈리아, 프랑스 등 외국 사신을 접견했다는 기록이 있다.&nbsp;<span style="color: rgb(19, 19, 19); text-align: justify;">이후 신정황후 조씨(24대 헌종의 어머니이자 26대 고종의 양어머니, 대한제국 선포 후 황후로 추존됨)가 세상을 떠난 곳이기도 하다.&nbsp;</span>흥복전은 일제강점기 때 철거되었다가 2020년에 복원하였다.</p>
                                    </div>
                                </div>
                                <div class="course_info box_wrap flex_center_align mb0 koglCodeInfo">
                                    <img src="course_img/nuri.svg" alt="공공누리 제1유형 : 공공누리 공공저작물 자유이용허락 출처표시" class="flex_shrink">
                            ...
                            <div class="tab_con cm11" data-tab="cm11">
                                <h3 class="txt_section_tit vcPartTitle">향원정</h3>
                                <div class="hidden">향원정</div>
                            ...
                            <div class="tab_con cm12" data-tab="cm12">
                                <h3 class="txt_section_tit vcPartTitle">건청궁</h3>
                                <div class="hidden">건청궁</div>
                                ...
                                <div class="course_txt_wrap">
                                    <div class="txt">
                                        <p style="text-align: justify;">건청궁(乾淸宮)은 1873년(고종 10)에 왕과 왕비의 생활공간으로 지어진 궁 안의 궁이다.&nbsp;건청궁의 왕의 생활공간인 장안당(長安堂)과 왕비의 생활공간인 곤녕합(坤寧閤) 등으로 구성되어 있는데, 장안당과 곤녕합은 복도로 이어져 있다. 이곳에서 고종과 명성황후는 10년 정도 생활하였다. 2007년에 지금의 모습으로 복원하였다.</p>
                                    </div>
                                </div>
                                <div class="course_info box_wrap flex_center_align mb0 koglCodeInfo">
                                    <img src="course_img/nuri.svg" alt="공공누리 제1유형 : 공공누리 공공저작물 자유이용허락 출처표시" class="flex_shrink">
                             ...
                             <div class="tab_con cm13" data-tab="cm13">
                                <h3 class="txt_section_tit vcPartTitle">집옥재</h3>
                                <div class="hidden">집옥재</div>
                                ...
                                <div class="course_txt_wrap">
                                    <div class="txt">
                                        <div style="text-align: justify;">집옥재(集玉齋)는 1891년(고종 28) 창덕궁 함녕전의 별당이었던 집옥재와 협길당 등을 건청궁 서쪽으로 옮겨지은 것으로, 고종의 서재와 외국 사신을 접견하던 장소로 사용되었다.&nbsp;<span style="color: rgb(19, 19, 19); text-align: justify;">집옥재를 중심으로 왼쪽에 팔우정(八隅亭), 오른쪽에 협길당(協吉堂)이 있다.&nbsp;</span>집옥재는 경복궁의 전각 중 유일하게 현판이 세로형으로 되어있다.</div>
                                    </div>
                                </div>
                                <div class="course_info box_wrap flex_center_align mb0 koglCodeInfo">
                                    <img src="course_img/nuri.svg" alt="공공누리 제1유형 : 공공누리 공공저작물 자유이용허락 출처표시" class="flex_shrink">
                            ...
                            <div class="tab_con cm14" data-tab="cm14">
                                <h3 class="txt_section_tit vcPartTitle">태원전</h3>
                                <div class="hidden">태원전</div>
                                ...
                                <div class="course_txt_wrap">
                                    <div class="txt">
                                        <div style="text-align: justify;">태원전(泰元殿)은 태조의 어진을 모셨고, 이후에는&nbsp;빈전(殯殿, 왕과 왕비가 세상을 떠난 후 발인하기 전까지 재궁(관)을 모셔둔 건물)으로 사용되었다.&nbsp;태원전 주변에는 부속 건물인 문경전(文慶殿)과 공묵재(恭默齋), 영사재(永思재) 등 의례용 건물이 있다. 태원전은&nbsp;2006년에 현재 모습으로 복원하였다.</div>
                                    </div>
                                </div>
                                <div class="course_info box_wrap flex_center_align mb0 koglCodeInfo">
                                    <img src="course_img/nuri.svg" alt="공공누리 제1유형 : 공공누리 공공저작물 자유이용허락 출처표시" class="flex_shrink">

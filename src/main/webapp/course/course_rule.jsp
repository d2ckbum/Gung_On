...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/course/css/course_rule_style.css" />
  ...
  <main>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <nav class="sub-nav">
                <ul>
                    <li><a href="/course/course_rule.jsp" class="active">관람규칙</a></li>
            ...
            <div class="sub_con_section">
                 <div class="box_wrap ">
                      <div class="txt_wrap">
                       ...
                       <img src="/course/course_rule_img/course_rule.jpg" alt="관람규칙 아이콘">
                 </div>
             </div>

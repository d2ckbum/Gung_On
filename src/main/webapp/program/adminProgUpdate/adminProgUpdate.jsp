    ...
    <div class="card p-4">
        <div class="row g-2">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="programName" name="programName" value="<%= program.getProgramName() %>" required>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label" for="languageKorean">한글</label>
                </div>
                <div class="form-check form-check-inline">

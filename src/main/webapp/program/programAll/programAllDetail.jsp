...
<div class="main_wrapper">
  ...
  <div class="sub_menu_box">
    ...
    <div class="menu_items_wrapper">
      ...
      <div class="menu_item <%= request.getRequestURI().endsWith("programAllDetail.jsp") ? "active" : "" %>">
...
<div class="program-detail-box">
  ...
  <% if (canReserve) { %>
    <button class="detail-btn black" type="button"
          onclick="location.href='/ticket/ticket_frm.jsp?programName=<%= java.net.URLEncoder.encode(dto.getProgramName(), "UTF-8") %>&imgFullPath=<%=imgFullPath%>'">
      예약하기
    </button>
  <% } else { %>

...
<div class="user-status-bar">
    <div class="user-status-logged-in" style="position: relative; right: 40px;">
      ...
      <a href="/mypage/mypage.jsp"><img src="/common/images/mainpage/user_profile.png">
      <strong>  마이페이지</strong></a>
      <a href="/login/logout.jsp"><img src="/common/images/mainpage/logout.png">
      <strong>  로그아웃</strong></a>
    </div> 
  <% } else { %>
    <div class="user-status-guest" style="position: relative; right: 40px;">
      <a href="/signup/sign_up.jsp"><img src="/common/images/mainpage/user_profile.png">
      <strong>  회원가입</strong></a>
      <a href="/login/login.jsp"><span class="login-icon"><i class="fa fa-user"></i></span>
      <img src="/common/images/mainpage/login.png"><strong>  로그인</strong></a>

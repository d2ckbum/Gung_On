...
public class SitePropertyVO {
	...
	private void setConfig() {
		...
		gungPicturePath="http://gungon.sist.co.kr/ticket/images/";
		...
		QRStorePath="http://gungon.sist.co.kr/ticket/ticketProcess/qr_process.jsp";
		
		//내부 컴퓨터의 저장 경로
		uploadQRPathInCom="/Gung_On/common/images/upload/QR/";
		
		defaultIP="gungon.sist.co.kr/Gung_On";
